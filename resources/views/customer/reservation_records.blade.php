...
<div class="container">
    ...
    <div class="edit hidden">
        <div class="edit-content justify-start text-start">
            ...
            @endif
            <form action="{{ route('customer.updateReservation') }}" method="POST"
                ...
                <div class="mb-2">
                    ...
                    <div class="relative">
                        ...
                        <div id="cottage-dropdown"
                            class="cottage-dropdown hidden absolute z-10 mt-1 w-full bg-white shadow-lg max-h-40 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                ...
                <div class="mb-2">
                    ...
                    <div class="relative">
                        ...
                        <div id="table-dropdown"
                            class="table-dropdown hidden absolute z-10 mt-1 w-full bg-white shadow-lg max-h-40 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
    ...
    <div id="cancelModal" class="fixed inset-0 z-[9999] bg-black bg-opacity-50 hidden items-center justify-center">
        <div class="bg-white rounded-lg p-6 shadow-xl w-full max-w-sm mx-auto">
            ...
            <p class="text-sm text-gray-600 mb-4">Are you sure you want to cancel this reservation? This action cannot
                be undone.</p>
            <div class="flex justify-end gap-3">
                <button id="cancelNo" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 text-sm">No</button>
                <button id="cancelYes" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 text-sm">Yes,
                    Cancel</button>
            </div>
        </div>
    </div>
